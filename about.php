...
Name: Rameel Zahid
Assignment: 05
Purpose: The purpose of this is to make the functions of the about page show all the text.
 */
...
$body = file_get_contents('templates/about.html');
...
$header_data = ["pagetitle" => "About Us Page"];
