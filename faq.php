...
Name: Rameel Zahid
Assignment: 05
Purpose: The purpose of this is to make the functions of the faq page show all the text.
 */
...
$body = file_get_contents('templates/faq.html');
...
$header_data = ["pagetitle" => "FAQ Page"];
