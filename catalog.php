...
Name: Rameel Zahid
Assignment: 05
Purpose: The purpose of this is to make the functions of the catalog page show all the text.
 */
...
$body = file_get_contents('templates/catalog.html');
...
$header_data = ["pagetitle" => "Catalog Page"];
